    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.CharField(help_text='Enter a brief description of the books', max_length=1000)),
                ('isbn', models.CharField(help_text='13 Character <ahref="https://www.isbn-international.org/content/what-jsbn">JSBN number</a>', max_length=13, verbose_name='ISBN')),
        ...
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, help_text='Unique ID for this particular book across \nwhole library', primary_key=True, serialize=False)),
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Select a genry for this book', to='catalog.genre'),
        ),
    ]
